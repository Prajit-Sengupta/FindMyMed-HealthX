...
import { MapPin, Search, Newspaper, Phone, Info, ChevronRight, Cross, Heart } from 'lucide-react';
      ...
      <div className="container mx-auto flex items-center justify-between px-8">
        ...
        <div className="w-1/2 pr-12">
          ...
          <p className="text-xl text-teal-700 mb-8">
            Quickly find pharmacies near you that have the exact medications you need. 
            Simple, fast, and reliable healthcare navigation.
          </p>
  ...
  return (
    <div className="min-h-screen bg-teal-50 flex items-center justify-center p-8">
      <div className="max-w-2xl bg-white p-10 rounded-xl shadow-lg">
        <h2 className="text-3xl font-bold mb-6 text-teal-600">About Find My Med</h2>
        <p className="text-teal-700 leading-relaxed mb-4">
          Find My Med is an innovative platform designed to simplify medication access. 
          Our mission is to connect patients with nearby pharmacies that have the exact medicines they need.
        </p>
        <div className="mt-6 grid md:grid-cols-3 gap-4">
          ...
          <div className="bg-teal-100 p-4 rounded-lg">
            ...
            <p className="text-teal-700">Precise pharmacy and medicine location</p>
          </div>
          <div className="bg-teal-100 p-4 rounded-lg">
...
const NewsletterPage = () => {
  ...
  return (
    <div className="min-h-screen bg-teal-50 flex items-center justify-center p-8">
      <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-lg">
        <h2 className="text-3xl font-bold mb-6 text-teal-600">Subscribe to Our Newsletter</h2>
